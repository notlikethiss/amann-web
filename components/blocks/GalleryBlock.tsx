  ...
  return (
    ...
    >
      ...
      <div className="gallery-info">
        ...
        >
          Наша кухня, пространство и меню постоянно развиваются по мере того,
          как мы черпаем вдохновение для создания самых невероятных впечатлений
          для наших гостей. Наша кухня, пространство и меню постоянно
          развиваются
        </Typography>
